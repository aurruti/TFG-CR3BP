...
# Plots
#system_plot(mu_earthsun,L1,L2,L4,L5,xlim=[0.472,0.527],ylim=[-0.882,-0.85],zoom=1,showSun=False, showEarth=False,showL1=False,showL2=False,showL4=False)
system_plot(mu_earthsun,L1,L2,L4,L5,xlim=[0.4998,0.50015],ylim=[-0.8661,-0.8659],zoom=3,showSun=False, showEarth=False,showL1=False,showL2=False,showL4=False)
...
fid1 = open('data/L5_PlanarOrbits.txt','w')
success_1 = 0
fail_1 = 0
success_2 = 0
fail_2 = 0
...
while not can_continue:
    ...
    if root1.success and (np.array([s0[0],s0[1],root1.x[0],root1.x[1]])-np.array(s_fin)<tol).all():
        ...
        #print(t_1)
        #shoot(mu_earthsun,[s0[0],s0[1],root1.x[0],root1.x[1]], t_1+10, style='-',res=3000)
...
plt.legend(handles=[legend_object1, legend_object2, legend_object3, legend_object4, legend_object5, legend_object6,legend_object7, legend_object8],labels=['','','','','','','', 'Long-term planar orbits'],ncols=11, handletextpad=0.5, handlelength=1.0, columnspacing=-0.5,loc='upper right')
